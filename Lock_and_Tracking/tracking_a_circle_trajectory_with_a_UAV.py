...
if __name__ == '__main__':
    ...
    while True:
        ...
        point1 = LocationGlobalRelative(40.2513633, 29.5565915, 50)

        point2 = LocationGlobalRelative(40.2513142, 29.5618701, 50)

        k = plane.vehicle.location.global_relative_frame
        ...
        if ((abs(x - a)) < 0.0005 and (abs(y - b)) < 0.00001):
            print("Point 1 e ilerlendi")
            plane.goto(point2)
